...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6); _sage_const_4 = Integer(4); _sage_const_9 = Integer(9); _sage_const_8 = Integer(8); _sage_const_12 = Integer(12); _sage_const_11 = Integer(11); _sage_const_10 = Integer(10); _sage_const_0p4 = RealNumber('0.4'); _sage_const_15 = Integer(15)
import csv
...
def build_game_analysis(data):
    ...
    enum_time = literal_eval(data[_sage_const_8 ])
...
def size_histogram():
    ...
    number_of_sizes = max(sizes) - _sage_const_4 
...
for i, v in enumerate(GAlist, start=_sage_const_1 ):
